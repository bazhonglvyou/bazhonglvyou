<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"E:\phpStudy\WWW\app\desk\sign\view\sign\index.html";i:1490015676;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head >
    <meta charset="UTF-8">
            ...
            <div class="row">
                <div class="col-md-6  wow fadeInRight">
                    <form action="" method="post" id="signForm" onsubmit="return false">
                        ...
                        <div class="col-md-6 from-group">
                            <input type="" class="form-control" name="stu_phone" placeholder="联系手机"/>
                        </div>
                        ...
                        <div class="col-md-12 from-group">
                            <select class="form-control" name="stu_xueli">
                                ...
                                <option value="">初中以下</option>
                                <option value="">社会人士</option>
                            </select>
                        </div>
                        <div class="col-md-12 from-group">
                            <select class="form-control" name="stu_zhuanye">
                                <option value="">意向专业</option>
                                <option value="">普通话技能班</option>
                                <option value="">办公技能班</option>
                                <option value="">UI设计师就业班</option>
                                <option value="">JAVA软件工程师就业班</option>
                                <option value="">PHP软件工程师就业班</option>
                                <option value="">Android软件工程师就业班</option>
                                <option value="">大数据工程师就业班</option>
                                <option value="">营销推广电商就业班</option>
                            </select>
                        </div>
