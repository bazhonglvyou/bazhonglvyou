<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\phpStudy\WWW\app\console\user\view\privilege\lookuser.html";i:1489473738;s:67:"E:\phpStudy\WWW\app\console\user\view\..\..\common\view\header.html";i:1489392067;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    $(function () {
        ...
        $('.delete').on('click', function () {
            ...
            layer.confirm('确定删除该角色下的用户？', {
                ...
                $.get("<?php echo Url('/user/privilege/deluser', '', false, true); ?>?urid=" + urid, function (data, status) {
                    if (data.code) {
