<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpStudy\WWW\bazhonglvyou\app\console\supplier\view\supplier\addtypelist.html";i:1489926035;s:84:"D:\phpStudy\WWW\bazhonglvyou\app\console\supplier\view\..\..\common\view\header.html";i:1489718237;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="ibox-title">
                    <form class="form-horizontal m-t" onsubmit="return false;" method="post" id="userForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"><input id="user_name" value="<?php echo isset($ticket['productName']) ? $ticket['productName'] :  ''; ?>" name="type_name" class="form-control" type="text"></div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">排序：</label>
                            <div class="col-sm-2">
                                <input id="product_one_price" name="sort" value="<?php echo isset($ticket['onePrice']) ? $ticket['onePrice'] :  ''; ?>" class="form-control" type="text">
                            </div>
                        </div>
