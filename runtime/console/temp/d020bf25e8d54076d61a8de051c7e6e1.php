<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\wamp\www\bazhonglvyou\app\console\menu\view\menu\edit.html";i:1489069153;s:76:"E:\wamp\www\bazhonglvyou\app\console\menu\view\..\..\common\view\header.html";i:1489069153;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="row">
            <div class="col-sm-8">
                <form class="form-horizontal m-t" onsubmit="return false;" method="post" id="menuForm">
                    ...
                    <div class="form-group <?php if(empty($info['icon']) || (($info['icon'] instanceof \think\Collection || $info['icon'] instanceof \think\Paginator ) && $info['icon']->isEmpty())): ?> hide <?php endif; ?>">
                        ...
                        <div class="col-sm-4">
                            ...
                            <button data-toggle="tooltip" data-placement="top" data-original-title="点击选择图标"
                                    class="btn btn-primary  btn-ico " type="button"><i class="fa <?php if(empty($info['icon']) || (($info['icon'] instanceof \think\Collection || $info['icon'] instanceof \think\Paginator ) && $info['icon']->isEmpty())): ?>fa-check<?php else: ?>fa-<?php echo $info['icon']; endif; ?>"></i>
                            </button>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input id="name" name="name" class="form-control" type="text" value="<?php echo $info['name']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">模块：</label>
                        <div class="col-sm-4">
                            <input id="module" name="module" class="form-control" type="text" value="<?php echo $info['module']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">控制器：</label>
                        <div class="col-sm-4">
                            <input id="controller" name="controller" class="form-control" type="text" value="<?php echo $info['controller']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">方法：</label>
                        <div class="col-sm-4">
                            <input id="action" name="action" class="form-control" type="text" value="<?php echo $info['action']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">参数：</label>
                        <div class="col-sm-4">
                            <input id="parameter" name="parameter" class="form-control" type="text" value="<?php echo $info['parameter']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea id="remark" name="remark" class="form-control" rows="3"><?php echo $info['remark']; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="redio-show" value="1" name="status"<?php if($info['status'] == '1'): ?> checked<?php endif; ?>>
                                <label for="redio-show"> 显示</label>
                            </div>
                            <div class="radio radio-inline">
                                <input type="radio" id="redio-hidden" value="2" name="status"<?php if($info['status'] == '2'): ?> checked<?php endif; ?>>
                    ...
                    <div class="form-group has-error">
                        <div class="col-sm-4 col-sm-offset-2">
                            <span id="server-error" style="display: none;" class="help-block m-b-none"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
    ...
    $().ready(function() {
        ...
        menuForm.validate({
            ...
            submitHandler: function() {
                ...
                // 提交表单
                $.ajax({
                    url: "<?php echo Url('/menu/menu/update',['id'=>$info['id']],false, true); ?>",
                    type: "post",
                    dataType: "json",
