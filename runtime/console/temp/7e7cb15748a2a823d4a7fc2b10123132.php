<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\phpStudy\WWW\app\console\user\view\privilege\rolelists.html";i:1489474181;s:67:"E:\phpStudy\WWW\app\console\user\view\..\..\common\view\header.html";i:1489392067;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo Url('user/privilege/lookuser',['roleid'=>$v['role_id']],false,true); ?>" class="btn btn-primary btn-xs btn-circle" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="查看角色具有的用户">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a href="<?php echo Url('user/privilege/add',['roleid'=>$v['role_id']],false,true); ?>" class="btn btn-primary btn-xs btn-circle" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="添加角色权限">
