<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\WWW\bazhonglvyou\app\console\supplier\view\supplier\gongtypelist.html";i:1489734509;s:75:"D:\WWW\bazhonglvyou\app\console\supplier\view\..\..\common\view\header.html";i:1489718237;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
        ...
        <div style="margin-left: 10px; margin-top: 6px;">
            ...
            <div style="margin-top: 60px;">
                <div style="margin-left: 300px;">
                    <!--分页开始-->
                    <?php if($page>=1) {?>
                    <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> 1]); ?>" style="width: 50px;" class="jiantou">首页</a>
                    <?php } if($page>1) {?>
                    <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> $page-1]); ?>" class="jiantou"><</a>
                    <?php } ?>
                    <span>
                        <?php for($i = $page-$ye+1;$i<$page;$i++) { if($i>0){ ?>
                         <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> $i]); ?>" style="display: inline-block; height: 20px; cursor: pointer; width: 26px; line-height: 20px;text-align: center; color: #333333;"><?php echo $i?></a>
                        <?php } } ?>
                        <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> $page]); ?>" style="display: inline-block; height: 20px; background: #009DDA; cursor: pointer;width: 26px; line-height: 20px;text-align: center;color: #ffffff "><?php echo $page ?></a>
                    ...
                    <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> $page+1]); ?>" class="jiantou">></a>
                    <?php } if ($maxpage>1) {?>
                    <a href="<?php echo url('supplier/supplier/gongtypelist',['page'=> $maxpage]); ?>" class="jiantou" style="width: 50px;">尾页</a>
                    <?php } ?>
                </div>
            </div>
       </div>
    ...
    <script>
        $('#delete_ticket').click(function(){
            ...
            if(idlist.length<0){
                ...
                $.post('<?php echo url("supplier/supplier/deltypegong"); ?>',{'listid':idlist},function(reg) {
                    alert('删除成功');
    ...
    <script>
        $('#create_ticket').click(
                function(){
                    location.href = '<?php echo url("supplier/supplier/addtypegong"); ?>';
                }
        );
