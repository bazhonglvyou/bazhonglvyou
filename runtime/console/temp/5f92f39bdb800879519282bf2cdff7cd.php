<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\phpStudy\WWW\bazhonglvyou\app\console\ticket\view\ticket\addlist.html";i:1489923993;s:82:"D:\phpStudy\WWW\bazhonglvyou\app\console\ticket\view\..\..\common\view\header.html";i:1489718237;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="wrapper wrapper-content">
    <div class="col-sm-12">
        <h3 class="pull-left"><?php echo !empty($id)?'修改':'添加'; ?>门票</h3>
                ...
                <div class="ibox-title">
                    <form class="form-horizontal m-t" onsubmit="return false;" method="post" id="userForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"><input id="user_name" value="<?php echo isset($ticket['productName']) ? $ticket['productName'] :  ''; ?>" name="productName" class="form-control" type="text"></div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属景点：</label>
                            <div class="col-sm-2">
                                <select class="form-control" name="ScenicSpotId" value="<?php echo isset($ticket['ScenicSpotId']) ? $ticket['ScenicSpotId'] :  ''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="productType" value="<?php echo isset($ticket['ScenicSpotId']) ? $ticket['ScenicSpotId'] :  ''; ?>">
                                    <option value="1">门票</option>
                                    <option value="2">酒店</option>
                                    <option value="3">特产</option>
                                    <option value="4">旅游路线</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="product_one_price" name="onePrice" value="<?php echo isset($ticket['onePrice']) ? $ticket['onePrice'] :  ''; ?>" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">是否上架：</label>
                            <div class="col-sm-5">
                                <input class="yes_c" type="radio" value="1" name="statu" style="width: 15px;vertical-align: middle;">
                                <span style="vertical-align: middle;color: #111111">是</span>
                                <input  class="no_c" type="radio" value="0"  name="statu" style="width: 15px;vertical-align: middle; margin-left: 16px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="password_confirm" value="<?php echo isset($ticket['salePrice']) ? $ticket['salePrice'] :  ''; ?>" name="salePrice" class="form-control" type="text">
                            </div>
                        </div>
    ...
    $().ready(function () {
        ...
        menuForm.validate({
            ...
            submitHandler: function () {
                ...
                // 提交表单
                $.ajax({
                    url: "<?php echo Url('/ticket/ticket/add'); ?>",
                    type: "post",
                    dataType: "json",
