<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wamp\www\bazhonglvyou\app\console\user\view\role\editrole.html";i:1489843271;s:76:"D:\wamp\www\bazhonglvyou\app\console\user\view\..\..\common\view\header.html";i:1489832979;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <form class="form-horizontal m-t" onsubmit="return false;" method="post" id="roleForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="old_role_name" class="form-control" value="<?php echo $role['role_name']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="role_code" class="form-control" value="<?php echo $role['role_code']; ?>">
                                <input type="hidden" name="old_role_code" class="form-control" value="<?php echo $role['role_code']; ?>">
                            </div>
                        </div>
    ...
    $().ready(function () {
        ...
        roleForm.validate({
            ...
            submitHandler: function () {
                ...
                // 提交表单
                $.ajax({
                    url: "<?php echo Url('/user/role/editrolesave','',false, true); ?>",
                    type: "post",
                    dataType: "json",
