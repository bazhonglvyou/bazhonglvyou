<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\wamp\www\bazhonglvyou\app\console\user\view\lists\add.html";i:1489315785;s:76:"E:\wamp\www\bazhonglvyou\app\console\user\view\..\..\common\view\header.html";i:1489069153;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    $().ready(function () {
        ...
        menuForm.validate({
            ...
            submitHandler: function () {
                ...
                // 提交表单
                $.ajax({
                    url: "<?php echo Url('/user/lists/save','',false, true); ?>",
                    type: "post",
                    dataType: "json",
