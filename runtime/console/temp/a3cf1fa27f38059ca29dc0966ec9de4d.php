<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\wamp\www\bazhonglvyou\app\console\user\view\role\add.html";i:1489845351;s:76:"D:\wamp\www\bazhonglvyou\app\console\user\view\..\..\common\view\header.html";i:1489832979;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    $().ready(function () {
        ...
        menuForm.validate({
            ...
            submitHandler: function () {
                ...
                // 提交表单
                $.ajax({
                    url: "<?php echo Url('/user/role/save','',false, true); ?>",
                    type: "post",
                    dataType: "json",
